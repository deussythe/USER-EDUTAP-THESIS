                ...
                <div className="flex items-center gap-1 bg-gray-100 rounded-lg p-0.5">
                    {RANGES.map(r => (
                        <button
                            ...
                            className={`px-2.5 py-1 rounded-md text-[11px] font-semibold transition-all ${range === r.days
                    ...
                    {dayTotals.map(({ label, total, isToday }, i) => {
                        ...
                        return (
                            <div key={i} className="flex flex-col items-center gap-1 flex-1 min-w-0">
                                ...
                                <span className={`text-[9px] font-medium truncate w-full text-center ${isToday ? "text-[#8B0000] font-bold" : "text-gray-400"
